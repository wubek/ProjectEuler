...
def generate_spiral_diagonals(size):
    '''
    actual value (1, 2, ...); step - how many new elements insert in direction; direction - 0 is right, 1 is down, etc
    we can see that after every two directions step increases (+1)
    we can also see that moving right element on diagonal is the one before last in this direction, and moving other directions
    is last
    '''
